...
for frame = 2:numIterations
    ...
    for row = 2:row_count + 1
        for col = 2:col_count + 1
            ...
            %         updated_animal_pop_cell = current_animal_pop - empty_count * animal_empty_diffuse_rate * current_animal_pop;
            %         updated_cell = ANIMAL;
            ...
            %         updated_animal_pop_cell = current_animal_pop;
...
for i = 1:numIterations
    ...
    h=heatmap(viz_fig2, animal_pop_grids(:,:,i), 'Colormap', copper);
    dood=heatmap(viz_fig69, pollen_conc_grids(:,:,i));
